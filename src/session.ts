...
export class SessionManager {
  ...
  constructor(options: SessionManagerOptions) {
    ...
    const initialSettings = this.getResolvedSettings();
    this.mcpManager = new McpManager(initialSettings.debugLogEnabled ?? false);
    this.toolExecutor = new ToolExecutor(this.projectRoot, this.createOpenAIClient, this.mcpManager);
    this.mcpManager.prepare(initialSettings.mcpServers);
