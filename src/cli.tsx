...
if (args.includes("--help") || args.includes("-h")) {
  process.stdout.write(
    [
      ...
      "  deepcode <directory>                  Launch in the specified directory",
...
function extractWorkingDirectory(args: string[]): string | undefined {
...
const customWorkingDir = extractWorkingDirectory(args);
const projectRoot = customWorkingDir || process.cwd();
...
function readPackageInfo(): PackageInfo {
  try {
    ...
    return {
      name: typeof pkg.name === "string" ? pkg.name : "ue-mcp-agent-ybai",
      version: typeof pkg.version === "string" ? pkg.version : "",
    };
  } catch {
    return { name: "ue-mcp-agent-ybai", version: "" };
  }
}
