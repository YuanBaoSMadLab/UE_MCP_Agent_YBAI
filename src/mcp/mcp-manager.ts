...
type ClientType = McpClient | HttpMcpClient;
...
export class McpManager {
  ...
  constructor(private readonly debugLogEnabled: boolean) {}
  ...
  private async refreshServerTools(serverName: string, client: ClientType): Promise<void> {
    const serverTools = await client.listTools(MCP_STARTUP_TIMEOUT_MS);
