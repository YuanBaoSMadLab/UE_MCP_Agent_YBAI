...
export async function promptForPendingUpdate(_packageInfo: PackageInfo): Promise<{ installed: boolean }> {
  return { installed: false };
}

export async function checkForNpmUpdate(_packageInfo: PackageInfo): Promise<void> {
  return;
}
