...
const UE5_TIPS = [
  { label: "/mcp", description: "View UE5.8 MCP server status and tools" },
  { label: "Tip", description: "Make sure UE5.8 editor is running with MCP plugin on port 8000" },
  { label: "Commands", description: "Try listing toolsets or creating geometry in your scene" },
  { label: "Scene Tools", description: "Load SceneTools to manipulate actors and geometry" },
];
  ...
  return (
    <Box flexDirection="column" marginY={1}>
        ...
        <Box flexDirection="column" paddingX={1}>
          ...
          >
            <Box flexGrow={1} marginBottom={compact ? 1 : 0}>
              ...
              <Text color={"#e94560"}> | </Text>
              <Text color={"#ff6b35"}>UE5.8 MCP Edition</Text>
            </Box>
            ...
            <Box marginTop={1}>
              ...
              <Text color="gray"> Connecting to UE5.8 at http://localhost:8000/mcp</Text>
            </Box>
          </Box>
        </Box>
      </Box>
      ...
      <Box flexDirection="column" width={panelWidth} paddingX={1}>
        ...
        {UE5_TIPS.map((ueTip, index) => (
          <Box key={index} marginTop={0.5}>
            <Text dimColor>
              • {ueTip.label}: {ueTip.description}
            </Text>
          </Box>
        ))}
      </Box>
